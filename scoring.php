		    		...
		    		$sqlQuery='SELECT * FROM tblcandidate ORDER BY PK_NUMBER ASC';
						...
						echo "
										<tr>
											...
											<th><a href='#' onclick='updateFromTemp()'>Casual Interview</a></th>
											<th>Swimsuit</th>
											<th>Evening Gown</th>
											<th>Average</th>
											<th>Rank</th>
			    						...
			    						$sqlQuery='SELECT * FROM tblcandidate ORDER BY PK_NUMBER ASC';
											...
											echo "
															<tr>
																...
																<th><a href='#' onclick='updateFromTemp()'>Swimsuit</th>
																<th>Evening Gown</th>
																<th>Average</th>
																<th>Rank</th>
										          </tr>
			    						...
			    						$sqlQuery='SELECT * FROM tblcandidate ORDER BY PK_NUMBER ASC';
											...
											echo "
															<tr>
																...
																<th>Casual Interview</a></th>
																<th>Swimsuit</th>
																<th><a href='#' onclick='updateFromTemp()'>Evening Gown</th>
																<th>Average</th>
																<th>Rank</th>
										          </tr>
										       ";
    						...
    						while($recordSet=mysqli_fetch_array($result))
							  {
							  	...
							  	$averageScore=number_format(($casualInterview+$swimsuit)/2,2);
							  	echo "
							  			<tr onclick='getPhoto(this.id)' id=".$recordSet['pk_number'].">
			  									<td   class='width'><a href='#'>".$recordSet['pk_number'] .". ". $recordSet['municipality'] ."</a></td>
			  									<td> <a href='#'>".$casualInterview." </a></td>
							  		...
							  		"; 
											...
											echo "<tr><td></td><td></td><td></td><td><input class='btn btn-primary' type='button' value='submit' onclick='submitMe()'></td></tr>";
											echo "</table>";
						break;
					    			...
					    			die();
			    						...
			    						$sqlQuery='SELECT pk_number,municipality,sum(score) as totalscore,fk_tbljudge_pkname,fk_tblcandidate_pknumber 
											...
											echo "
															<tr>
																<th class='width'>Candidate</th>
																<th><a href='#' onclick='updateFromTemp()'>Casual Interview</th>
																<th>Rank</th>
										          </tr>
										       ";
						...
						while($recordSet=mysqli_fetch_array($result))
					  {
					  	...
					  	<div class='place'>
          					...
          					<div class='listname'>
          							...
          							<p>".$recordSet['age']." years of age</p>
          							<!--<p>36 - 24 - 38</p>-->
          					</div>
											  	...
											  	$sqlGetPrevScoresRecordset = mysqli_fetch_row($sqlGetPrevScoresResult);
											  		...
											  		if 	($recordSets != null)
											  		{
													  	echo "
													  			<tr onclick='getPhoto(this.id)' id=".$recordSet['pk_number'].">
									  									<td   class='width'><a href='#'>".$recordSet['pk_number'] .". ". $recordSet['municipality'] ."</a></td>
									  									<td> <a href='#'>".$sqlGetPrevScoresRecordset[0]." </a></td>
									  									<td> <input type='text' onblur='tempSave(this.value,".$recordSet['pk_number'].")' value='".$recordSets[0]."'> </td>
									  									<td> - </td>
										 ...
										 while($recordSet=mysqli_fetch_array($result))
											  {
											  	...
											  	$sqlGetPrevScores="SELECT score,pk_number FROM tblscore JOIN tblcandidate on tblscore.fk_tblcandidate_pknumber = tblcandidate.pk_number
													...
													$prevScoreAverage=number_format(($casualInterview+$swimsuit)/2,2);
...
//												 die();
							  	...
							  	$averageScore=number_format(($casualInterview+$swimsuit+$eveningGown)/3,2);
							  	echo "
							  			<tr onclick='getPhoto(this.id)' id=".$recordSet['pk_number'].">
			  									<td   class='width'><a href='#'>".$recordSet['pk_number'] .". ". $recordSet['municipality'] ."</a></td>
			  									<td> <a href='#'>".$casualInterview." </a></td>
